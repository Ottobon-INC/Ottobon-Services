      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Empowering the future of AI-driven consulting. Learn from AI to become faster, smarter, and more effective.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#courses" className="text-gray-300 hover:text-blue-400 transition-colors text-sm">
                  Courses
                </a>
              </li>
              <li>
                <a href="#talent-compass" className="text-gray-300 hover:text-blue-400 transition-colors text-sm">
                  Assessment
                </a>
              </li>
              <li>
                <a href="#enroll" className="text-gray-300 hover:text-blue-400 transition-colors text-sm">
                  Enrollment
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center text-sm">
                ...
                <a href="mailto:hr@ottobon.in" className="text-gray-300 hover:text-blue-400 transition-colors">
                  hr@ottobon.in
                </a>
              </li>
              <li className="flex items-center text-sm">
              ...
              <li className="flex space-x-3 mt-4">
                <a href="https://www.linkedin.com/company/ottobon-academy-pvt-ltd/posts/?feedView=all" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-gray-800 hover:bg-blue-600 rounded-full flex items-center justify-center transition-all">
        ...
        <div className="pt-6 border-t border-gray-700/50 flex flex-col md:flex-row justify-between items-center text-sm">
          <p className="text-gray-400 mb-3 md:mb-0">
            © {new Date().getFullYear()} OttoBon Technology Consulting Academy. All rights reserved.
          </p>
